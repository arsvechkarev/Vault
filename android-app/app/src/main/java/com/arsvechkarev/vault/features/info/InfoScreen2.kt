...
import com.arsvechkarev.vault.features.info.InfoScreen2.ImageType.COPY
import com.arsvechkarev.vault.features.info.InfoScreen2.ImageType.OPEN_IN_NEW
...
class InfoScreen2 : BaseFragmentScreen() {
  ...
  private fun render(state: Info2ScreenState) {
  ...
  private fun showInfoDialog(state: Info2ScreenState) {
