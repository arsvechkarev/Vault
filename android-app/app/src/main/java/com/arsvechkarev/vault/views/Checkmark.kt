...
class Checkmark(context: Context) : View(context) {
    ...
    private val checkmarkAppear = ContextCompat.getDrawable(
        context,
        R.drawable.avd_chechmark_appear
    ) as AnimatedVectorDrawable

    private val checkmarkDisappear = ContextCompat.getDrawable(
        context,
        R.drawable.avd_chechmark_disappear
    ) as AnimatedVectorDrawable
