...
@rem ##########################################################################
@rem
@rem  desktop-app startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and DESKTOP_APP_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DESKTOP_APP_OPTS%  -classpath "%CLASSPATH%" com.arsvechkarev.vaultdesktop.MainApp %*
...
:fail
rem Set variable DESKTOP_APP_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%DESKTOP_APP_EXIT_CONSOLE%" exit 1
exit /b 1
